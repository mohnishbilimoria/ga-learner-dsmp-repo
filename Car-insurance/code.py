...
df['HOME_VAL'] = df['HOME_VAL'].astype(str).str.replace('$','').str.replace(',','')
df['BLUEBOOK'] = df['BLUEBOOK'].astype(str).str.replace('$','').str.replace(',','')
df['OLDCLAIM'] = df['OLDCLAIM'].astype(str).str.replace('$','').str.replace(',','')
df['CLM_AMT'] = df['CLM_AMT'].astype(str).str.replace('$','').str.replace(',','')
