...
size = dataset.drop('Cover_Type', axis=1).size
...
#X_train1 = skb.transform(X_train1)
predictors = skb.fit_transform(X_train1,Y_train)
scores = skb.scores_

Features = X_train.columns
#dataframe = pd.DataFrame(columns = ['Features','scores'])
...
#top_k_predictors = dataframe['Features'].head(20)
...
#scaled_features_train_df = X_train[top_k_predictors]
